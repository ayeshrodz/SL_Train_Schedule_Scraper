...
def fetch_train_schedule(start_station_id, end_station_id, verify=True):
    # URL and form data
    ...
    try:
        # Make the POST request, use `verify` parameter to handle SSL verification dynamically
            ...
            if table:
                for row in table.find_all("tr"):
                    ...
                    if len(cells) == 8:
                        ...
                        additional_info_cells = additional_row.find_all("td") if additional_row else []
